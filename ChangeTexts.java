...
public class ChangeTexts {
    ...
    public void NewRoundTexts(Player human, Player enemy, JProgressBar pr1, JProgressBar pr2, JLabel label, JLabel label2, JLabel label3, JLabel label4, JLabel label5) {
        action.HP(human, pr1);
        action.HP(enemy, pr2);
